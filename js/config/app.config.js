/**
 * Natyam ERP v3 — Admin — Application configuration
 *
 ...
 * app's table lives in js/config/navigation.js. Everything else — the domain
 * enums, CAPABILITIES, ROLES and the reference-data resolution seam — is
 * shared verbatim with natyam-mobile, so permission logic cannot drift
...
export const APP = Object.freeze({
    ...
    // splitting the reference project in two and redesigning the desktop
    // surface. See CHANGELOG.md and MIGRATION_CHECKLIST.md.
    version: '3.1.0',
