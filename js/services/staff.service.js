/**
 * Natyam ERP v3 — Admin — Staff service
 *
 * COMPLETED IN STAGE 22, from the partial copy Stage 14 made. Only
 * `availableTeachers()` was carried across then — the batch form's teacher
 * picker was the sole caller, and hire/deactivate/listStaff/teacherDashboard/
 * payrollTrend would have dragged in salaries$, programs$ and attendance$ for
 * code nothing ran. With the Staff module now migrated the rest has real
 * callers, so this is the reference file in full. Copied verbatim: if it is
 * fixed there, fix it here too.
 *
